...
@RestController
@RequestMapping("/api/jawnzapp-kafka")
public class JawnzappKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JawnzappKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JawnzappKafkaResource(KafkaProperties kafkaProperties) {
